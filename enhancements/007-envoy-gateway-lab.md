...
the VIP move, gRPC; MetalLB is demo 52) — **one-cluster lab** (demo 54: `eg-poc1`, kube-vip, HTTP and gRPC through
two Gateways, reachable from the MacBook).
...
`poc4` 10.40/10.41): **eg1 `10.50.0.0/16` / `10.51.0.0/16`, eg2 `10.60.0.0/16` / `10.61.0.0/16`, eg-poc1 `10.70.0.0/16` / `10.71.0.0/16`** — so the two labs
