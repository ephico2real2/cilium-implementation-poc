...
| Seven kind nodes on the Docker VM | Four nodes; the VM (10 CPU / 24 GiB) at **17.0 GiB used**, ~1.1 cores busy; poc2's control-plane Tetragon burned 4.2 cores in a cgroup warning loop until restarted today (9m after) | Memory headroom ≈ 7 GiB against ≈ 1–2 GiB the platform adds at HPA maximum — no resize; §7's memory risk downgraded; the Tetragon loop goes to the gotchas |
