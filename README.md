...
9. Keep **[docs/GOTCHAS.md](docs/GOTCHAS.md)** open throughout — 66 traps, each with the real error
   text.
...
| ✅ | `scripts/verify.sh` → VERIFICATION_RUN.md (853 lines, 18 sections, including the native client, the bank, the monitoring stack, OBI, the zero-trust cell and the Spring Boot lab) | regenerable |
...
The committed result is **[docs/VERIFICATION_RUN.md](docs/VERIFICATION_RUN.md)** — 853 lines of
...
**[docs/GOTCHAS.md](docs/GOTCHAS.md)** lists all 66 traps this build actually hit — not things that
