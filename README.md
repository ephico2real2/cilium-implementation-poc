...
| [docs/FINDINGS.md](docs/FINDINGS.md), [docs/REFERENCES.md](docs/REFERENCES.md), [docs/HUBBLE-L7-LABELS.md](docs/HUBBLE-L7-LABELS.md) | the measurements; every external source with what it was used for; why Hubble's L7 dashboard goes blind to Gateway traffic and the lab's app-keyed dashboard, with its references and the alignment measured |
