...
| ✅ | `scripts/verify.sh` → VERIFICATION_RUN.md (891 lines, 19 sections, including the native client, the bank, the monitoring stack, OBI, the zero-trust cell, the Spring Boot lab and Tempo) | regenerable |
...
The committed result is **[docs/VERIFICATION_RUN.md](docs/VERIFICATION_RUN.md)** — 891 lines of
