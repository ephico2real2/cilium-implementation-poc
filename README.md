...
10. Keep **[docs/GOTCHAS.md](docs/GOTCHAS.md)** open throughout — 104 traps, each with the real error
   text.
...
**[docs/GOTCHAS.md](docs/GOTCHAS.md)** lists all 104 traps this build actually hit — not things that
