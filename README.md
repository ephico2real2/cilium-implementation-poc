...
9. Keep **[docs/GOTCHAS.md](docs/GOTCHAS.md)** open throughout — 87 traps, each with the real error
   text.
...
| ✅ | **Enhancement 001 released (demos 29 →)** — cf2cnp 0.6.0 (E1–E6, E10), hubble-policy-verdicts 0.2.0 (E7), the observer fork with both and the E8 example; demo 29 proves E1 and E9 on the mesh, demo 30 E2 (L7 rules), demo 31 E3 (DNS visibility → toFQDNs), demo 32 E4+E5+E10 (the operator's loop; two findings fixed as cf2cnp 0.6.1) | in progress: demos 33–34 prove the rest; `enhancements/README.md` |
...
**[docs/GOTCHAS.md](docs/GOTCHAS.md)** lists all 87 traps this build actually hit — not things that
