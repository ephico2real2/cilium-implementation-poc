...
| ✅ | **Enhancement 001 released (demos 29 →)** — cf2cnp 0.6.0 (E1–E6, E10), hubble-policy-verdicts 0.2.0 (E7), the observer fork with both and the E8 example; demo 29 proves E1 and E9 on the mesh, demo 30 E2 (L7 rules), demo 31 E3 (DNS visibility → toFQDNs), demo 32 E4+E5+E10 (the operator's loop; two findings fixed as cf2cnp 0.6.1), demo 33 E6 (hardening), demo 34 E7+E8 (verdict → policy on one page; which policy allowed it) | **done** — every item proven, issues #1–#10 closed; `enhancements/README.md` |
