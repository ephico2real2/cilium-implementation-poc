...
9. Keep **[docs/GOTCHAS.md](docs/GOTCHAS.md)** open throughout — 86 traps, each with the real error
   text.
...
| ✅ | **Enhancement 001 released (demos 29 →)** — cf2cnp 0.6.0 (E1–E6, E10), hubble-policy-verdicts 0.2.0 (E7), the observer fork with both and the E8 example; demo 29 proves E1 and E9 on the mesh, demo 30 E2 (L7 rules), demo 31 E3 (DNS visibility → toFQDNs) | in progress: demos 32–34 prove the rest; `enhancements/README.md` |
...
**[docs/GOTCHAS.md](docs/GOTCHAS.md)** lists all 86 traps this build actually hit — not things that
