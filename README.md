...
9. Keep **[docs/GOTCHAS.md](docs/GOTCHAS.md)** open throughout — 65 traps, each with the real error
   text.
...
**[docs/GOTCHAS.md](docs/GOTCHAS.md)** lists all 65 traps this build actually hit — not things that
