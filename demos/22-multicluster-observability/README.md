...
**grafana multicluster compute** — both clusters named in one table — poc2’s rows arrive by remote write, poc1’s carry the cluster label from the scrape class

![grafana-multicluster-compute](output/screenshots/grafana-multicluster-compute.png)

**grafana network overview bank poc2** — the same Hubble dashboard, cluster=poc2: metrics scraped by the edge Prometheus and written to the hub

![grafana-network-overview-bank-poc2](output/screenshots/grafana-network-overview-bank-poc2.png)

**grafana cilium metrics poc2** — Cilium metrics of poc2 in the hub Grafana

![grafana-cilium-metrics-poc2](output/screenshots/grafana-cilium-metrics-poc2.png)
...
monitoring-kube-prometheus-operator-57b74d8f5b-zw957     1/1     Running   9 (103s ago)    19h     10.10.3.227   poc1-worker2          <none>         
monitoring-kube-state-metrics-7f584dc46d-dpxkb           1/1     Running   11 (114s ago)   19h     10.10.4.165   poc1-worker           <none>         
monitoring-prometheus-node-exporter-d9h5h                1/1     Running   3 (2m2s ago)    19h     172.18.0.7    poc1-control-plane2   <none>         
monitoring-prometheus-node-exporter-fzxrc                1/1     Running   2 (101s ago)    19h     172.18.0.3    poc1-control-plane3   <none>         
...
prometheus-monitoring-kube-prometheus-prometheus-0       2/2     Running   1 (69s ago)     177m    10.10.3.98    poc1-worker2          <none>         
tempo-0                                                  1/1     Running   6 (79s ago)     8h      10.10.3.228   poc1-worker2          <none>         
```

```console
$ kubectl --context kind-poc2 -n monitoring get pods -o wide
NAME                                                   READY   STATUS    RESTARTS        AGE   IP            NODE                 NOMINATED NODE   REA
edge-kube-prometheus-stack-operator-8578f59fbd-mpc69   1/1     Running   5 (80s ago)     9h    10.20.1.230   poc2-worker          <none>           <no
edge-kube-state-metrics-5886d7cc86-n4pzc               1/1     Running   6 (7h31m ago)   9h    10.20.1.152   poc2-worker          <none>           <no
edge-prometheus-node-exporter-fjfvm                    1/1     Running   2 (8h ago)      9h    172.18.0.10   poc2-control-plane   <none>           <no
edge-prometheus-node-exporter-jxv9n                    1/1     Running   3 (69s ago)     9h    172.18.0.9    poc2-worker          <none>           <no
prometheus-edge-kube-prometheus-stack-prometheus-0     1/2     Running   1 (8s ago)      9h    10.20.1.178   poc2-worker          <none>           <no
```
