#!/usr/bin/env python3
"""every line inside a recorded ```text block of demo 53's README must exist
...
"""
import re, sys
readme = open('demos/53-grpc-parity/README.md').read()
tx = {l.rstrip() for l in open('demos/53-grpc-parity/output/transcript.txt')}
