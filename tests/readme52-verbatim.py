#!/usr/bin/env python3
"""every line inside a recorded ```text block of demo 52's README must exist
...
"""
import re, sys
readme = open('demos/52-eg-poc2-metallb/README.md').read()
tx = {l.rstrip() for l in open('demos/52-eg-poc2-metallb/output/transcript.txt')}
